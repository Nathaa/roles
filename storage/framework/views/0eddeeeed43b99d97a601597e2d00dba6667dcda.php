     ...
     <div class="row">
        <div class="col">
         ...
         <div class="col">
                ...
                <?php echo e(Form::text('descripcion_padecimiento',null,['class' => 'form-control','id'=>'descripcion_padecimiento', 'placeholder' => 'Pequeña descripción del padecimiento'])); ?>
        ...
        <div class="col">
                ...
                <?php echo e(Form::text('alergia_medicamento',null,['class' => 'form-control','id'=>'alergia_medicamento','placeholder' => 'Si tiene alergia algun medicamento'])); ?>
...
<?php /**PATH C:\Users\IsraelErazo\Desktop\Proyecto\roles\resources\views/estudiantes/form.blade.php ENDPATH**/ ?>