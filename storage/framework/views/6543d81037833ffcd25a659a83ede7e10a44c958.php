            ...
            $(function printOnSelect(){
              ...
              if(flag){
                ...
                var comboSelect = document.getElementById('turnos_id');
                  ...
                  //para el sexo
                  var sexoOriginal=<?php echo json_encode($sexoOriginal ??''); ?>;

                  var sexos = <?php echo json_encode($arraySexo); ?>;
...
<?php /**PATH C:\Users\IsraelErazo\Desktop\Proyecto\roles\resources\views/docentes/form.blade.php ENDPATH**/ ?>