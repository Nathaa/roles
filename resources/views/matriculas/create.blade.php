...
<div class="col-sm">
    ...
    <a href="#" data-toggle="modal" data-target="#modalConsultarCupos"> <button type="button" id="btnModal" class="btn btn-dark btn-xs"  >{{-- onclick="miFuncion()" --}}
...
@if(count($errors)>0)
 ...
 @include('matriculas.modalConsultarCupos')<!-- aqui meto el modal -->
@endsection
